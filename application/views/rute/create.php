<div class="container-fluid p-0">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?= site_url('Rute/save') ?>" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                <label for="lokasi" class="form-label">Lokasi:</label>
                                <input type="text" class="form-control" id="lokasi" name="lokasi" placeholder="Contoh : lapangan" required>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="hari" class="form-label">Hari:</label>
                                <input type="text" class="form-control" id="hari" name="hari" placeholder="Contoh : senin dan jumat" required>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="waktu" class="form-label">Jam:</label>
                                <input type="time" class="form-control" id="waktu" name="waktu" placeholder="Contoh : 09:00" required>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="latitude" class="form-label">Latitude:</label>
                                <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Contoh : -7.0023481" required>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="longitude" class="form-label">Longitude:</label>
                                <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Contoh : 110.843232" required>
                            </div>
                            <div class="mt-4 col-12">
                                <label for="posisi" class="form-label">Posisi:</label>
                                <input type="text" class="form-control" id="posisi" name="posisi" placeholder="Contoh : -7.3421, 110.3214" required>
                            </div>
                        </div>
