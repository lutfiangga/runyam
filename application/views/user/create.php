                    ...
                    <form method="POST" action="<?= site_url('User/save') ?>" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Contoh : lapangan" required>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="username" class="form-label">Username:</label>
                                <input type="text" class="form-control" id="username" name="username" placeholder="Contoh : senin dan jumat" required>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="password" class="form-label">Password:</label>
                                <input type="text" class="form-control" id="password" name="password" placeholder="Contoh : 09:00" required>
                            </div>
                        </div>
