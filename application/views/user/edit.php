                    ...
                    <form method="POST" action="<?= site_url('User/update/') . $edit['id_user'] ?>" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" value="<?= $edit['nama'] ?>" placeholder="Contoh : budi" required>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="username" class="form-label">Username:</label>
                                <input type="text" class="form-control" id="username" name="username" value="<?= $edit['username'] ?>" placeholder="Contoh : admin" required>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="password" class="form-label">Password:</label>
                                <input type="text" class="form-control" id="password" name="password" value="<?= $edit['password'] ?>" placeholder="Contoh : Admin#1234" required>
                            </div>
                        </div>
