<section class="container mx-auto px-4 text-justify w-3/4 mb-8">
    {/* <!-- Terms & Conditions --> */};
    <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold mt-24 mb-12 text-gray-300 text-center">
    ...
    <div class="text-gray-500 gap-4">
        <div>
            <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-300 my-6">
                Penggunaan Layanan
            </h3>
        ...
        <div>
            ...
            <p class="text-base md:text-md lg:text-lg">
