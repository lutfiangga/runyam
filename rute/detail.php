<div class="container-fluid p-0">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="<?= site_url('Rute/update/') . $detail['id_rute'] ?>" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                ...
                                <input type="text" class="form-control" id="hari" name="hari" value="<?= $detail['hari'] ?>" readonly>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="waktu" class="form-label">Jam:</label>
                                <input type="time" class="form-control" id="waktu" name="waktu" value="<?= $detail['waktu'] ?>" readonly>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="latitude" class="form-label">Latitude:</label>
                                <input type="text" class="form-control" id="latitude" name="latitude" value="<?= $detail['latitude'] ?>" readonly>
                            </div>
                            <div class="mt-4 col-12 col-sm-6 col-md-6">
                                <label for="longitude" class="form-label">Longitude:</label>
                                <input type="text" class="form-control" id="longitude" name="longitude" value="<?= $detail['longitude'] ?>" readonly>
                            </div>
                            <div class="mt-4 col-12">
                                <label for="posisi" class="form-label">Posisi:</label>
                                <input type="text" class="form-control" id="posisi" name="posisi" value="<?= $detail['posisi'] ?>" readonly>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center gap-4 mt-4">
                            <a href="<?= site_url('Rute') ?>" class="btn btn-secondary me-2">Kembali</a>
